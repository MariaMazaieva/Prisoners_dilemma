...
import Cooperate_player
import Defect_player

# define the payoff matrix; see game.py for detailed explanation of this matrix
# payoff_matrix = ( ((2,2),(6,1)) , ((1,6),(4,4)) )
payoff_matrix = ( ((4,4),(1,6)) , ((6,1),(2,2)) )
# (6,1),(2,2) (4,4),(1,6) (2,2) (1,6) ( ((4,4),(1,6)) , ((6,1),(2,2)) )
# define the number of iterations
number_of_iterations = 20

# create the players
playerA = Random_player.MyPlayer(payoff_matrix, number_of_iterations)
